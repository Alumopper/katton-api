...
import { ref, computed, watch, defineComponent, shallowRef, watchEffect, onMounted, nextTick, onBeforeUnmount, unref, markRaw, createApp, useSSRContext } from "vue";
...
import { t as toValue, u as unrefElement, n as notNullish, a as tryOnScopeDispose, i as inBrowser, s as sanitizeFileName, b as useData, c as computedAsync, d as useSessionStorage, e as useLocalStorage, w as watchDebounced, o as onKeyStroke, f as useRouter, g as createSearchTranslate, h as useEventListener, j as useScrollLock, k as dataSymbol, l as escapeRegExp } from "./app.js";
import { _ as _export_sfc } from "./plugin-vue_export-helper.1tPrXgE0.js";
const localSearchIndex = { "root": () => import("./@localSearchIndexroot.BPb3UXz1.js") };
/*!
* tabbable 6.4.0
      ...
      createClass(Mark3, [{
        ...
        value: function checkRanges(array) {
          ...
          array.sort(function(a, b) {
            ...
            var _callNoMatchOnInvalid = _this3.callNoMatchOnInvalidRanges(item, last2), start = _callNoMatchOnInvalid.start, end = _callNoMatchOnInvalid.end, valid = _callNoMatchOnInvalid.valid;
            if (valid) {
              item.start = start;
        ...
        value: function mark2(sv, opt) {
          ...
          var _getSeparatedKeywords = this.getSeparatedKeywords(typeof sv === "string" ? [sv] : sv), kwArr = _getSeparatedKeywords.keywords, kwArrLen = _getSeparatedKeywords.length, sens = this.opt.caseSensitive ? "" : "i", handler = function handler2(kw) {
            ...
            _this10[fn](regex, 1, function(term, node) {
              return _this10.opt.filter(node, kw, totalMatches, matches2);
            }, function(element) {
              matches2++;
              totalMatches++;
...
function pathToFile(path) {
  ...
  if (inBrowser) {
    ...
    return !pageHash ? null : `${base}${"assets"}/${pagePath}.${pageHash}.js`;
  }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const mark2 = computedAsync(async () => {
    ...
    watchDebounced(
      ...
      async ([index, filterTextValue, showDetailedListValue], old, onCleanup) => {
        ...
        await new Promise((r) => {
          var _a3;
          (_a3 = mark2.value) == null ? void 0 : _a3.unmark({
            done: () => {
              var _a4;
              (_a4 = mark2.value) == null ? void 0 : _a4.markRegExp(formMarkRegex(terms), { done: r });
            }
          });
        });
        ...
        excerpts.forEach((excerpt) => {
          var _a3;
          (_a3 = excerpt.querySelector('mark[data-markjs="true"]')) == null ? void 0 : _a3.scrollIntoView({ block: "center" });
        });
        (_b2 = (_a2 = resultsEl.value) == null ? void 0 : _a2.firstElementChild) == null ? void 0 : _b2.scrollIntoView({ block: "start" });
      },
    ...
    function focusSearchInput(select = true) {
      ...
      if (select) (_b2 = searchInput.value) == null ? void 0 : _b2.select();
    }
    onMounted(() => {
      focusSearchInput();
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        var _a2, _b2, _c, _d;
        _push2(`<div role="button"${ssrRenderAttr("aria-owns", ((_a2 = results.value) == null ? void 0 : _a2.length) ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-f5b6d5db><div class="backdrop" data-v-f5b6d5db></div><div class="shell" data-v-f5b6d5db><form class="search-bar" data-v-f5b6d5db><label${ssrRenderAttr("title", buttonText.value)} id="localsearch-label" for="localsearch-input" data-v-f5b6d5db><svg class="search-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-f5b6d5db><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-f5b6d5db><circle cx="11" cy="11" r="8" data-v-f5b6d5db></circle><path d="m21 21l-4.35-4.35" data-v-f5b6d5db></path></g></svg></label><div class="search-actions before" data-v-f5b6d5db><button class="back-button"${ssrRenderAttr("title", unref(translate)("modal.backButtonTitle"))} data-v-f5b6d5db><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-f5b6d5db><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m7 7l-7-7l7-7" data-v-f5b6d5db></path></svg></button></div><input${ssrRenderAttr("value", unref(filterText))}${ssrRenderAttr("placeholder", buttonText.value)} id="localsearch-input" aria-labelledby="localsearch-label" class="search-input" data-v-f5b6d5db><div class="search-actions" data-v-f5b6d5db>`);
        if (!disableDetailedView.value) {
          _push2(`<button type="button" class="${ssrRenderClass([{ "detailed-list": unref(showDetailedList) }, "toggle-layout-button"])}"${ssrRenderAttr("title", unref(translate)("modal.displayDetails"))} data-v-f5b6d5db><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-f5b6d5db><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 14h7v7H3zM3 3h7v7H3zm11 1h7m-7 5h7m-7 6h7m-7 5h7" data-v-f5b6d5db></path></svg></button>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? " disabled" : ""}${ssrRenderAttr("title", unref(translate)("modal.resetButtonTitle"))} data-v-f5b6d5db><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-f5b6d5db><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 5H9l-7 7l7 7h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2Zm-2 4l-6 6m0-6l6 6" data-v-f5b6d5db></path></svg></button></div></form><ul${ssrRenderAttr("id", ((_b2 = results.value) == null ? void 0 : _b2.length) ? "localsearch-list" : void 0)}${ssrRenderAttr("role", ((_c = results.value) == null ? void 0 : _c.length) ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", ((_d = results.value) == null ? void 0 : _d.length) ? "localsearch-label" : void 0)} class="results" data-v-f5b6d5db><!--[-->`);
        ssrRenderList(results.value, (p, index) => {
          _push2(`<li role="option"${ssrRenderAttr("aria-selected", selectedIndex.value === index ? "true" : "false")} data-v-f5b6d5db><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{
            selected: selectedIndex.value === index
          }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))} data-v-f5b6d5db><div data-v-f5b6d5db><div class="titles" data-v-f5b6d5db><span class="title-icon" data-v-f5b6d5db>#</span><!--[-->`);
          ssrRenderList(p.titles, (t, index2) => {
            _push2(`<span class="title" data-v-f5b6d5db><span class="text" data-v-f5b6d5db>${t ?? ""}</span><svg width="18" height="18" viewBox="0 0 24 24" data-v-f5b6d5db><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 18l6-6l-6-6" data-v-f5b6d5db></path></svg></span>`);
          });
          _push2(`<!--]--><span class="title main" data-v-f5b6d5db><span class="text" data-v-f5b6d5db>${p.title ?? ""}</span></span></div>`);
          if (unref(showDetailedList)) {
            _push2(`<div class="excerpt-wrapper" data-v-f5b6d5db>`);
            if (p.text) {
              _push2(`<div class="excerpt" inert data-v-f5b6d5db><div class="vp-doc" data-v-f5b6d5db>${p.text ?? ""}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="excerpt-gradient-bottom" data-v-f5b6d5db></div><div class="excerpt-gradient-top" data-v-f5b6d5db></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></a></li>`);
        ...
        if (unref(filterText) && !results.value.length && enableNoResults.value) {
          _push2(`<li class="no-results" data-v-f5b6d5db>${ssrInterpolate(unref(translate)("modal.noResultsText"))} &quot;<strong data-v-f5b6d5db>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</ul><div class="search-keyboard-shortcuts" data-v-f5b6d5db><span data-v-f5b6d5db><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateUpKeyAriaLabel"))} data-v-f5b6d5db><svg width="14" height="14" viewBox="0 0 24 24" data-v-f5b6d5db><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5m-7 7l7-7l7 7" data-v-f5b6d5db></path></svg></kbd><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateDownKeyAriaLabel"))} data-v-f5b6d5db><svg width="14" height="14" viewBox="0 0 24 24" data-v-f5b6d5db><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m7-7l-7 7l-7-7" data-v-f5b6d5db></path></svg></kbd> ${ssrInterpolate(unref(translate)("modal.footer.navigateText"))}</span><span data-v-f5b6d5db><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.selectKeyAriaLabel"))} data-v-f5b6d5db><svg width="14" height="14" viewBox="0 0 24 24" data-v-f5b6d5db><g fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-f5b6d5db><path d="m9 10l-5 5l5 5" data-v-f5b6d5db></path><path d="M20 4v7a4 4 0 0 1-4 4H4" data-v-f5b6d5db></path></g></svg></kbd> ${ssrInterpolate(unref(translate)("modal.footer.selectText"))}</span><span data-v-f5b6d5db><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.closeKeyAriaLabel"))} data-v-f5b6d5db>esc</kbd> ${ssrInterpolate(unref(translate)("modal.footer.closeText"))}</span></div></div></div>`);
      }, "body", false, _parent);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/vitepress-carbon@1.5.0_@alg_708b6ac05193a19b6c36dad9571067a5/node_modules/vitepress-carbon/dist/theme/components/VPLocalSearchBox.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f5b6d5db"]]);
export {
