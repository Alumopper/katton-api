...
| --- | --- |
| `message` | The message to display (will be converted to Component if not already) |
...
| --- | --- |
| `message` | The message to display |
| `tinted` | Whether to apply a background tint |
...
| Parameter | Description |
| --- | --- |
| `message` | The title message to display |
...
| Parameter | Description |
| --- | --- |
| `message` | The subtitle message to display |
